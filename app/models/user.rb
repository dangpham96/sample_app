class User < ApplicationRecord
  ...
  validates :password, presence: true, length: { minimum: Settings.validation_user.password_user_min }, allow_nil: true
  ...
  def password_reset_expired?
    reset_sent_at < Settings.time_password_reset_expired.hours.ago
  end

  def feed
    following_ids = following.pluck(:id) << id
    Micropost.by_user_ids following_ids
  end
